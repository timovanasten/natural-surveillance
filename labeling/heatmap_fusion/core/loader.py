...
from ..common_pytorch.dp import DataProvider


class FacadeDataset(DataProvider):
    def __init__(self, db_list, is_train, patch_width, patch_height, label_func, aug_config, label_config):
        super(FacadeDataset, self).__init__(db_list, is_train, patch_width, patch_height, label_func, aug_config, label_config)
